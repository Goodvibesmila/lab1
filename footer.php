<!-- Här ska man länka in JS-filer eftersom att javascript oftast ska läsas
    efter att hemsidan har laddats. t.ex ska CSS och html-kod läsas först. 


< ?php wp_footer(); ?>     -behöver jag denna?
</body>
</html>
-->
